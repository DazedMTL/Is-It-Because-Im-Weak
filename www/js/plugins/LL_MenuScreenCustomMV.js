...
(function () {
  ...
  var menuWindowPictureScale = Number(
  ...
  Scene_Menu.prototype.create = function () {
    ...
    if (menuHelpWindowEnable) {
      ...
      this._statusWindow.height =
        this._statusWindow.height - this._menuHelpWindow.height;
      this._statusWindow.refresh();
    }
    this._statusWindow.reserveStandingPictures();
  };

  var _Scene_ItemBase_createActorWindow =
  ...
  Scene_ItemBase.prototype.createActorWindow = function () {
    ...
    if (menuHelpWindowEnable) {
      ...
      this._actorWindow.height =
        this._actorWindow.height - this.calcMenuHelpWindowHeight();
  ...
  Scene_Menu.prototype.update = function () {
    ...
    // インフォメーションウィンドウの更新
    var helpText = menuHelpLists[this._commandWindow.currentName()]
