...
Yanfly.MoreQuests2.version = 1.0;
...
if (Imported.YEP_QuestJournal) {
  ...
  text +=
    "YEP_X_MoreQuests2 without YEP_QuestJournal. Please visit Yanfly.moe ";
  text +=
    "and install YEP_QuestJournal in your game project before you can use ";
  text += "this plugin.";
  console.log(text);
