...
Moghunter.dmgp_zoom_effect = String(
  Moghunter.parameters["Zoom Effect"] || "true"
);
Moghunter.dmgp_center_y = String(
  Moghunter.parameters["Center Y-Axis"] || "true"
);
...
// ** perform Reflection
//==============================
var _mog_dmgpop_gbat_performReflection =
...
Sprite_Damage.prototype.initialize = function () {
  ...
  this._zoomEffect =
    String(Moghunter.dmgp_zoom_effect) === "true" ? true : false;
...
Sprite_Damage.prototype.createDigits = function (baseRow, value) {
  ...
  for (var i = 0; i < string.length; i++) {
    ...
    sprite.dy = -i;
    if (this._zoomEffect) {
      this.setZoomEffect(sprite, string.length * 2, i);
    }
  }
...
//==============================
var _mog_sprtdmb_setupCriticalEffect =
...
Sprite_Damage.prototype.updateChild = function (sprite) {
  ...
  if (sprite.zt <= 0) {
    this.updateDmgSpriteEffect(sprite);
  }
};
...
Sprite_Enemy.prototype.damageOffsetY = function () {
  if (this._dmgCenter && this.bitmap) {
    return -this.bitmap.height / 2 + this._battler._dmgOffsetY + 16;
  }
  return this._battler._dmgOffsetY;
};
