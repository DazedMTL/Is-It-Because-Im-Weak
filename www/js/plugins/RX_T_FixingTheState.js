...
(() => {
  ...
  Game_Battler.prototype.rx_chgStatePerm = function (stateId) {
    ...
    rx_systemState =
      stateId === 2 || stateId === 3 || (stateId === 1 && this.hp <= 0);
  ...
  Game_Battler.prototype.addState = function (stateId) {
    ...
    const rx_stLkResult2 =
      $dataStates[stateId].meta[rx_lockStWord] !== undefined ||
      $gameTemp._rx_ctrlStateFEv;
