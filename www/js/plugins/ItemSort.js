...
(function () {
  ...
  Window_ItemList.prototype.refreshSortSprite = function () {
    if (this._sortSprite) {
      ...
      this._sortSprite.bitmap.gradientFillRect(
        0,
        0,
        30,
        20,
  ...
  Window_ItemList.prototype.drawItem = function (index) {
    ...
    if (
      this.isHighlightNewItem() &&
      item &&
      newerItemColor1 &&
      $gameSystem.newerItems().contains(cItem)
    ) {
  ...
  Window_ItemList.prototype.itemSort = function () {
    ...
    switch (type) {
      case "new":
        ...
        break;
      case "idA":
        ary = this.sortId(ary, 1);
        break;
      case "idB":
        ary = this.sortId(ary, -1);
        break;
      case "kanaA":
        ary = this.sortKana(ary, 1);
        break;
      case "kanaB":
        ary = this.sortKana(ary, -1);
        break;
      case "priceA":
        ary = this.sortPrice(ary, 1);
        break;
      case "priceB":
        ary = this.sortPrice(ary, -1);
        break;
      case "usable":
        ary = this.sortUsable(ary, 1);
        break;
    }
